...
public class Dish implements Serializable{
	...
	public Dish(String dishName, DishType type, ArrayList<Component> componenets, int timeToMake, String dishPicPath) {
		super();
		this.id = idCounter++;
	...
	public String toString() {
		String compsString = "";
		for(Component c: this.componenets) {
			compsString += c.getComponentName() + " ";
		}
		return "JAVA-EAT ID: " + id + "\n" + "Name: " + dishName + "\n" + "Type: " + type + "\n" + "Price: " + String.format("%.2f", price) + " $" + "\n" + "Time to make: "
				+ timeToMake + "\n" + "Components: " + compsString;
	}
